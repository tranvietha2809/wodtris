namespace Wordtris.GameCore
{
    public class WordisSettings
    {
        public WordisSettings(
            ...
            int height = 10,
            int minWordLength = 3,
            int waterLevel = 0, bool tetrominoBlock = false)
        {
            Speed = speed;
        ...
        public bool TetrominoBlock { get; }
        ...
        public WordisSettings With(
            ...
            int? waterLevel = null, bool? tetrominoBlock = null) =>
            new WordisSettings(
                speed: speed ?? Speed,
                width: width ?? Width,
                height: height ?? Height,
                minWordLength: minWordLength ?? MinWordLength,
                waterLevel: waterLevel ?? WaterLevel, tetrominoBlock: tetrominoBlock ?? TetrominoBlock);
    }
}
